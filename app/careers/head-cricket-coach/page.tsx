...
const data: JobPostingData = {
  ...
  about: [
    "We are launching a new youth cricket academy in the Greater Philadelphia area and are seeking a founding Head Cricket Coach to build the program from the ground up. This is a rare opportunity to establish a brand-new academy's identity, curriculum, and competitive standing rather than step into an existing structure — you will be the first technical hire and a defining voice in how the program takes shape.",
